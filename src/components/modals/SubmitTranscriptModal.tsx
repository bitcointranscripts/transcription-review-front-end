...
const ConfirmSubmitModalContent = ({ onClose: closeModal, onSubmit: submitTranscript, prRepo }: ReviewEditsContentProps) => {
  return (
    <>
...
const SubmitModalContent = ({ status, data: prUrl, error }: SubmitContentProps) => {
...
const SubmitTranscriptModal = ({ isOpen, onClose: closeModal, onSubmit, prRepo, submitReview }: Props) => {
    ...
    <Modal isOpen={isOpen} onClose={handleClose} isCentered>
      ...
      <ModalContent>
        {submitReview.status == "idle" ?
          <ConfirmSubmitModalContent onClose={handleClose} onSubmit={onSubmit} prRepo={prRepo} />
